...
public class AuthorServletController extends HttpServlet {
	...
	private void addNewAuthor(HttpServletRequest request, HttpServletResponse response) throws ParseException, SQLException {
	...
	private void listAuthor(HttpServletRequest request, HttpServletResponse response) throws ParseException, SQLException, ServletException, IOException {
	...
	private void deleteAuthor(HttpServletRequest request, HttpServletResponse response)
		...
		private void loadAuthor(HttpServletRequest request, HttpServletResponse response) 
			...
			RequestDispatcher dispatcher = 
					request.getRequestDispatcher("/author/update-author-form.jsp");
			dispatcher.forward(request, response);		
		}
